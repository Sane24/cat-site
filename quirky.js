...
catImage.addEventListener('click', function() {
  ...
  if (patCount.innerText % 5 == 0) {
    const audio = new Audio('shizuneko.mp3');
    audio.play();
  }

  if (patCount.innerText % 11 == 0) {
    const audio = new Audio('groupcat.mp3');
    audio.play();
  }

  if (patCount.innerText % 3 == 0) {
    const audio = new Audio('sadnekoshizu.mp3');
    audio.play();
  }

  if (patCount.innerText % 7 == 0) {
    const audio = new Audio('angryshizuneko.mp3');
    audio.play();
  }
